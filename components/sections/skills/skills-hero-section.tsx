        ...
        >
            ...
            <div className="absolute top-4 left-4 sm:top-6 sm:left-6 md:top-8 md:left-8 z-20 font-mono text-[10px] md:text-xs text-purple-400/60 hidden md:block">
                <div className="flex items-center gap-2">
                    ...
                    <span>MODULE: SKILLS_MATRIX</span>
                </div>
            ...
            <div className="relative z-10 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20">
                <motion.div variants={staggerItem}>
                    ...
                    >
                        <div className="absolute left-0 top-0 w-1 h-full bg-gradient-to-b from-purple-500 via-pink-500 to-blue-500 rounded-full" />
                        <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 font-light pl-4 sm:pl-6 md:pl-8 leading-relaxed max-w-3xl">
                            A comprehensive arsenal of modern technologies and frameworks, mastered through years of hands-on development and continuous learning.
                        </p>
                    </motion.div>
                    ...
                    >
                        {[
                            { icon: Layers, label: 'Skill Categories', value: totalCategories, gradient: 'from-purple-500 to-pink-500', suffix: '' },
                            { icon: Code2, label: 'Total Skills', value: totalSkills, gradient: 'from-pink-500 to-blue-500', suffix: '+' },
                            { icon: Award, label: 'Expert Level', value: expertSkills, gradient: 'from-blue-500 to-purple-500', suffix: '+' }
                        ].map((stat, idx) => (
                            <motion.div
                                key={stat.label}
